import {_ as h, r as a, o as d, c as B, w as y, a as s, n as v, b as f, t as $, d as c, F as k, e as M, f as K, v as G, g as P, h as S, i as H, j as g, k as O, l as I, m as U, p as X, q as L, s as J, u as Q, x as Z, y as ee} from "./index.5553c785.js";
...
function le(e, n, t, r, l, u) {
    ...
    f("a", {
        key: 0,
        class: v(["text-base flex items-center justify-center rounded-md p-4 hover:text-opacity-80 cursor-pointer font-bold", {
    ...
    f("button", {
        key: 1,
        class: v(["text-base flex items-center justify-center rounded-md p-4 hover:text-opacity-80 font-bold", {
            "bg-main-dark text-white": !t.light,
            "bg-light text-black": t.light
        }])
    }, $(t.title), 3))
...
const ge = h(me, [["render", xe]])
  ...
  , ve = {
    class: "flex items-center justify-between py-5 w-full max-w-8xl mx-auto 3xl:px-0 px-8"
}
  , be = {
    class: "xl:flex items-center gap-7 hidden"
}
  , $e = ["href"]
  , ke = {
  ...
  , Se = {
    class: "mobile-nav fixed top-0 inset-x-0 transition transform origin-top xl:hidden z-50"
}
  , Te = {
    class: "rounded-b-lg shadow-md bg-black text-white bg-opacity-95 ring-1 ring-black ring-opacity-5 overflow-hidden"
}
  , Ce = {
  ...
  , We = {
    class: "flex flex-col gap-3 border-t pt-4 border-gray-800"
}
  , Le = ["href"];
function je(e, n, t, r, l, u) {
    ...
    return d(),
    f("nav", {
        class: v(["fixed top-0 w-full z-50", l.scrolled ? "bg-white bg-opacity-80" : "bg-transparent"])
    }, [s("div", ve, [c(o), s("div", be, [(d(!0),
    f(k, null, M(l.links, (i,_)=>(d(),
    f(k, {
        key: _
    }, [i.anchor ? (d(),
    f("a", {
    ...
    B(p, {
        ...
        class: "block"
    })])])]), K(s("div", Se, [s("div", Te, [s("div", Ce, [c(o), s("button", {
        type: "button",
        class: "rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-600",
    ...
    f("a", {
        key: 0,
        class: "px-4 block text-base font-medium bg-transparent border-b pb-4 border-b-gray-800",
        href: i.url,
        target: "_blank",
        rel: "noopener noreferrer"
    }, $(i.name), 9, Le)) : (d(),
    B(p, {
        ...
        to: i.url,
        class: "px-4 block text-base font-medium bg-transparent border-b pb-4 border-b-gray-800",
        onClick: n[2] || (n[2] = b=>l.expandMenu = !1)
    }, {
        default: y(()=>[P($(i.name), 1)]),
        _: 2
    }, 1032, ["to"]))]))), 128)), c(m, {
...
function De(e, n, t, r, l, u) {
    return d(),
    f("div", {
        class: v(["flex flex-col gap-5 z-10 relative", {
            "items-center justify-center": t.center,
            "items-start": !t.center
        }])
    }, [s("h1", {
        class: v(["w-full max-w-main font-bold", {
        ...
        class: v(["xl:text-2xl text-xl w-full", {
            "text-center": t.center,
            "max-w-prose": !t.fullDescription
        }])
    }, $(t.description), 3), s("div", Ae, [S(e.$slots, "button")])], 2)
}
...
const Ie = H({
    ...
    setup(e, {emit: n}) {
        ...
        return U(async()=>{
            ...
            m.value = setInterval(()=>{
                p.value++,
                e.loop !== 0 && p.value === e.loop && (n("onComplete"),
...
function qe(e, n, t, r, l, u) {
    ...
    f("div", {
        ...
        key: e.componentKey,
        onMouseenter: n[0] || (n[0] = (...o)=>e.hoverStarted && e.hoverStarted(...o)),
        onMouseleave: n[1] || (n[1] = (...o)=>e.hoverEnded && e.hoverEnded(...o)),
        onMousedown: n[2] || (n[2] = (...o)=>e.mouseDown && e.mouseDown(...o)),
        onMouseup: n[3] || (n[3] = (...o)=>e.mouseUp && e.mouseUp(...o))
    }, [s("div", Re, null, 512), e.showGradient ? (d(),
    f("div", He)) : L("", !0), s("div", Ue, [S(e.$slots, "default")], 512), s("div", Ve, [S(e.$slots, "default")]), (d(!0),
    f(k, null, M(e.cloneAmount, o=>(d(),
    f("div", {
        class: "marquee cloned",
        key: o
    }, [S(e.$slots, "default")]))), 128))], 36)) : L("", !0)
}
...
function Qe(e, n, t, r, l, u) {
    ...
    B(o, {
        ...
        class: "bg-main-dark w-full p-6 text-white flex items-center xl:text-4xl text-xl"
    }, {
        default: y(()=>[Fe, ze, Ke, Ge, Xe, Je]),
        _: 1
    }, 8, ["direction"])
}
...
const et = {
  ...
  , nt = {
    class: "relative w-full flex flex-col items-center justify-center h-screen hero-min-height"
}
  , ot = {
    class: "w-full flex items-center sm:justify-between justify-center max-w-8xl 3xl:px-0 px-12"
}
  , st = {
    class: "mt-4 flex gap-5 flex-wrap xl:mb-0 mb-10"
}
  , rt = s("img", {
    src: Ze,
    alt: "",
    class: "sm:h-3/4 h-1/2 w-auto mix-blend-luminosity absolute xl:bottom-30 2xl:bottom-48 bottom-10 lg:bottom-24 md:bottom-20 right-0 opacity-50 xl:opacity-100 object-contain bg-white rounded-full"
}, null, -1);
function at(e, n, t, r, l, u) {
    ...
    f("div", tt, [s("div", nt, [s("div", ot, [c(p, {
        ...
        class: "divider -skew-y-6 bottom-20 w-full"
    })])])
}
...
function dt(e, n, t, r, l, u) {
    ...
    f("div", {
        id: t.id,
        class: v(["flex flex-col relative w-full py-10 lg:py-20 overflow-hidden", {
            "px-12": !t.noPadding,
            "px-12 xl:px-0": t.noPadding
        }])
    }, [s("div", {
        class: v(["w-full mx-auto max-w-7xl lg:max-w-8xl md:max-w-4xl", {
            "my-auto": t.center
        }])
    }, [t.title ? (d(),
    B(o, {
        ...
        center: t.center,
        primary: !1
    }, null, 8, ["title", "description", "center"])) : L("", !0), S(e.$slots, "default")], 2)], 10, ct)
}
...
const mt = h(ut, [["render", pt]])
  ...
  , xt = {
    class: "flex items-center xl:flex-row flex-col w-full"
}
  , gt = s("img", {
    src: _t,
    alt: "",
    class: "ml-auto xl:-mr-40 xl:h-1/2 xl:w-1/2 z-10"
}, null, -1)
  , yt = s("img", {
    src: ht,
    alt: "",
    class: "absolute top-0 left-0 w-full opacity-25"
}, null, -1);
function vt(e, n, t, r, l, u) {
    ...
    return d(),
    B(m, null, {
        default: y(()=>[s("div", xt, [c(p, {
            title: "Where We Are Going",
            description: "The designer had one question in mind when he created the baby in that video; what would a 2 foot tall modern ape look like? We have reserved 1% of the token supply for this visionary.",
            primary: !1
        }, {
            button: y(()=>[c(o, {
                "is-link": "",
...
var R = Object.getOwnPropertySymbols
  ...
  , It = (e,n)=>{
    var t = {};
    for (var r in e)
        Dt.call(e, r) && n.indexOf(r) < 0 && (t[r] = e[r]);
    if (e != null && R)
        for (var r of R(e))
            n.indexOf(r) < 0 && Pt.call(e, r) && (t[r] = e[r]);
    return t
}
  , Rt = (e,n)=>{
    const t = e.__vccOpts || e;
...
const Nt = {
  ...
  , Ft = {
    class: "flex items-center justify-center xl:flex-row flex-col-reverse w-full xl:gap-20 gap-10"
};
...
const Kt = h(Nt, [["render", zt]])
  ...
  , Jt = {
    class: "flex items-center justify-between xl:flex-row flex-col"
}
  , Qt = s("img", {
    src: Gt,
    alt: "",
...
const on = h(tn, [["render", nn]])
  ...
  , rn = {
    class: "bg-main-dark w-full h-full py-5"
}
  , an = {
    class: "flex items-center xl:justify-between xl:flex-row flex-col justify-center gap-5 max-w-8xl mx-auto 3xl:px-0 px-5"
}
  , ln = s("p", {
...
function fn(e, n, t, r, l, u) {
    const o = a("Nav")
      ...
      , C = a("Footer");
    return d(),
    f(k, null, [c(o), c(p), c(m), c(w), c(x), c(i), c(_), c(b), c(C)], 64)
}
